...
function renderHome() {
  ...
  const savedName = localStorage.getItem('at_display_name');
  const name = savedName || user?.user_metadata?.full_name || user?.email?.split('@')[0] || 'there';
      ...
      <div class="lg-center">
        ...
        <div class="lg-search-wrap">
          <div class="lg-search">
            ...
            <input type="text" class="lg-search-input" placeholder="Search inventory…" id="homeSearchInput" oninput="homeSearch(this.value)" />
          </div>
        </div>
        <div class="lg-nav-btns">
          <button class="lg-nav-btn" onclick="switchTab('inventory')">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-4 0v2M8 7V5a2 2 0 0 0-4 0v2"/></svg>
            Inventory
          </button>
          <button class="lg-nav-btn" onclick="switchTab('scan')">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="8" x2="4" y2="16"/><line x1="8" y1="6" x2="8" y2="18"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="16" y1="6" x2="16" y2="18"/><line x1="20" y1="8" x2="20" y2="16"/></svg>
            Scan
          </button>
          <button class="lg-nav-btn" onclick="switchTab('add')">
          ...
          <button class="lg-nav-btn" onclick="switchTab('borrow')">
